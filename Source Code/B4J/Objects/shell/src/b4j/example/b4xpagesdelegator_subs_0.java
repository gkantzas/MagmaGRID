...
try {
		Debug.PushSubsStack("Activity_Pause (b4xpagesdelegator) ","b4xpagesdelegator",18,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("Activity_Resume (b4xpagesdelegator) ","b4xpagesdelegator",18,__ref.getField(false, "ba"),__ref,48);
...
try {
		Debug.PushSubsStack("Initialize (b4xpagesdelegator) ","b4xpagesdelegator",18,__ref.getField(false, "ba"),__ref,4);
...
try {
		Debug.PushSubsStack("MainForm_Closed (b4xpagesdelegator) ","b4xpagesdelegator",18,__ref.getField(false, "ba"),__ref,13);
...
try {
		Debug.PushSubsStack("MainForm_CloseRequest (b4xpagesdelegator) ","b4xpagesdelegator",18,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("MainForm_FocusChanged (b4xpagesdelegator) ","b4xpagesdelegator",18,__ref.getField(false, "ba"),__ref,9);
...
try {
		Debug.PushSubsStack("MainForm_IconifiedChanged (b4xpagesdelegator) ","b4xpagesdelegator",18,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("MainForm_Resize (b4xpagesdelegator) ","b4xpagesdelegator",18,__ref.getField(false, "ba"),__ref,44);
