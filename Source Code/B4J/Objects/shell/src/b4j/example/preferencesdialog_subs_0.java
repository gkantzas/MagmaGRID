...
Debug.JustUpdateDeviceLine();
preferencesdialog.__c.runVoidMethod ("LogImpl","918481201",RemoteObject.concat(RemoteObject.createImmutable("Unknown type: "),_prefitem.getField(true,"ItemType" /*RemoteObject*/ )),0);
 break; }
}
;
 }
