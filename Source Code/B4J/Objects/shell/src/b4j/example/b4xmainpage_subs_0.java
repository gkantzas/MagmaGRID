...
Debug.ShouldStop(1048576);
 BA.debugLineNum = 120;BA.debugLine="Dim m As Map=mg.GetValues";
Debug.ShouldStop(8388608);
_m = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_m = __ref.getField(false,"_mg" /*RemoteObject*/ ).runClassMethod (b4j.example.magmagrid.class, "_getvalues" /*RemoteObject*/ );Debug.locals.put("m", _m);Debug.locals.put("m", _m);
 BA.debugLineNum = 121;BA.debugLine="if m.IsInitialized then Log(m.GetValueAt(0))";
Debug.ShouldStop(16777216);
if (_m.runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
b4xmainpage.__c.runVoidMethod ("LogImpl","0393220",BA.ObjectToString(_m.runMethod(false,"GetValueAt",(Object)(BA.numberCast(int.class, 0)))),0);};
 BA.debugLineNum = 127;BA.debugLine="Log(\"Total without VAT: \" & mg.SumRows(\"Tot.Price";
Debug.ShouldStop(1073741824);
b4xmainpage.__c.runVoidMethod ("LogImpl","0393226",RemoteObject.concat(RemoteObject.createImmutable("Total without VAT: "),__ref.getField(false,"_mg" /*RemoteObject*/ ).runClassMethod (b4j.example.magmagrid.class, "_sumrows" /*RemoteObject*/ ,(Object)(BA.ObjectToString("Tot.Price wo VAT")),(Object)(RemoteObject.createImmutable("")))),0);
 BA.debugLineNum = 130;BA.debugLine="Log(\"Total with VAT: \" & mg.SumRows(\"Tot.Price w";
Debug.ShouldStop(2);
b4xmainpage.__c.runVoidMethod ("LogImpl","0393229",RemoteObject.concat(RemoteObject.createImmutable("Total with VAT: "),__ref.getField(false,"_mg" /*RemoteObject*/ ).runClassMethod (b4j.example.magmagrid.class, "_sumrows" /*RemoteObject*/ ,(Object)(BA.ObjectToString("Tot.Price w VAT")),(Object)(RemoteObject.createImmutable("")))),0);
 BA.debugLineNum = 133;BA.debugLine="Log(\"only VAT 13%: \" & mg.SumRows(\"VAT\",\"SELECT";
Debug.ShouldStop(16);
b4xmainpage.__c.runVoidMethod ("LogImpl","0393232",RemoteObject.concat(RemoteObject.createImmutable("only VAT 13%: "),__ref.getField(false,"_mg" /*RemoteObject*/ ).runClassMethod (b4j.example.magmagrid.class, "_sumrows" /*RemoteObject*/ ,(Object)(BA.ObjectToString("VAT")),(Object)(RemoteObject.createImmutable("SELECT  SUM([VAT]) as myvalue FROM data WHERE [Vat%]='13.00';")))),0);
 BA.debugLineNum = 136;BA.debugLine="Dim newlist As List=mg.GetData";
Debug.ShouldStop(128);
...
_newlist = __ref.getField(false,"_mg" /*RemoteObject*/ ).runClassMethod (b4j.example.magmagrid.class, "_getdata" /*RemoteObject*/ );Debug.locals.put("newlist", _newlist);Debug.locals.put("newlist", _newlist);
 BA.debugLineNum = 139;BA.debugLine="mg.SetData(newlist)";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("Button2_Click (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,144);
...
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 146;BA.debugLine="Dim newlist As List = mg.GetData";
Debug.ShouldStop(131072);
_newlist = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_newlist = __ref.getField(false,"_mg" /*RemoteObject*/ ).runClassMethod (b4j.example.magmagrid.class, "_getdata" /*RemoteObject*/ );Debug.locals.put("newlist", _newlist);Debug.locals.put("newlist", _newlist);
 BA.debugLineNum = 147;BA.debugLine="If newlist.Size>0 Then";
Debug.ShouldStop(262144);
if (true) break;
...
//C
this.state = 6;
 BA.debugLineNum = 148;BA.debugLine="Dim maxRow() As Object = newlist.Get(newlist.Siz";
Debug.ShouldStop(524288);
_maxrow = (_newlist.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_newlist.runMethod(true,"getSize"),RemoteObject.createImmutable(1)}, "-",1, 1))));Debug.locals.put("maxRow", _maxrow);Debug.locals.put("maxRow", _maxrow);
 BA.debugLineNum = 149;BA.debugLine="Dim newID As Int = maxRow(0) + 1 'aeric's fix";
Debug.ShouldStop(1048576);
...
//C
this.state = 6;
 BA.debugLineNum = 151;BA.debugLine="Dim newID As Int = 1";
Debug.ShouldStop(4194304);
...
this.state = -1;
;
 BA.debugLineNum = 153;BA.debugLine="newlist.Add(Array As String(newID,\"\",\"\",DateTime.";
Debug.ShouldStop(16777216);
_newlist.runVoidMethod ("Add",(Object)((RemoteObject.createNewArray("String",new int[] {8},new Object[] {BA.NumberToString(_newid),BA.ObjectToString(""),BA.ObjectToString(""),BA.NumberToString(parent.__c.getField(false,"DateTime").runMethod(true,"getNow")),BA.ObjectToString("0.00"),BA.ObjectToString("0.00"),BA.ObjectToString("1.00"),RemoteObject.createImmutable("24.00")}))));
 BA.debugLineNum = 154;BA.debugLine="mg.SetData(newlist)";
Debug.ShouldStop(33554432);
__ref.getField(false,"_mg" /*RemoteObject*/ ).runClassMethod (b4j.example.magmagrid.class, "_setdata" /*void*/ ,(Object)(_newlist));
...
this.state = -1;
;
 BA.debugLineNum = 156;BA.debugLine="mg.CalcAll";
Debug.ShouldStop(134217728);
