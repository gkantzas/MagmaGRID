...
RDebugUtils.currentLine=393219;
 //BA.debugLineNum = 393219;BA.debugLine="Dim m As Map=mg.GetValues";
_m = new anywheresoftware.b4a.objects.collections.Map();
_m = __ref._mg /*b4j.example.magmagrid*/ ._getvalues /*anywheresoftware.b4a.objects.collections.Map*/ (null);
RDebugUtils.currentLine=393220;
 //BA.debugLineNum = 393220;BA.debugLine="if m.IsInitialized then Log(m.GetValueAt(0))";
if (_m.IsInitialized()) { 
__c.LogImpl("0393220",BA.ObjectToString(_m.GetValueAt((int) (0))),0);};
RDebugUtils.currentLine=393226;
 //BA.debugLineNum = 393226;BA.debugLine="Log(\"Total without VAT: \" & mg.SumRows(\"Tot.Price";
__c.LogImpl("0393226","Total without VAT: "+BA.NumberToString(__ref._mg /*b4j.example.magmagrid*/ ._sumrows /*double*/ (null,"Tot.Price wo VAT","")),0);
RDebugUtils.currentLine=393229;
 //BA.debugLineNum = 393229;BA.debugLine="Log(\"Total with VAT: \" & mg.SumRows(\"Tot.Price w";
__c.LogImpl("0393229","Total with VAT: "+BA.NumberToString(__ref._mg /*b4j.example.magmagrid*/ ._sumrows /*double*/ (null,"Tot.Price w VAT","")),0);
RDebugUtils.currentLine=393232;
 //BA.debugLineNum = 393232;BA.debugLine="Log(\"only VAT 13%: \" & mg.SumRows(\"VAT\",\"SELECT";
__c.LogImpl("0393232","only VAT 13%: "+BA.NumberToString(__ref._mg /*b4j.example.magmagrid*/ ._sumrows /*double*/ (null,"VAT","SELECT  SUM([VAT]) as myvalue FROM data WHERE [Vat%]='13.00';")),0);
RDebugUtils.currentLine=393235;
 //BA.debugLineNum = 393235;BA.debugLine="Dim newlist As List=mg.GetData";
...
RDebugUtils.currentLine=393238;
 //BA.debugLineNum = 393238;BA.debugLine="mg.SetData(newlist)";
