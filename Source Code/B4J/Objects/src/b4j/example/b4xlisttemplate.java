...
RDebugUtils.currentLine=31981570;
 //BA.debugLineNum = 31981570;BA.debugLine="CustomListView1.Clear";
__ref._customlistview1 /*b4j.example.customlistview*/ ._clear();
RDebugUtils.currentLine=31981571;
 //BA.debugLineNum = 31981571;BA.debugLine="For Each opt As Object In Options";
if (true) break;
...
RDebugUtils.currentLine=31981572;
 //BA.debugLineNum = 31981572;BA.debugLine="CustomListView1.AddTextItem(opt, opt)";
__ref._customlistview1 /*b4j.example.customlistview*/ ._addtextitem(_opt,_opt);
 if (true) break;
if (true) break;
;
RDebugUtils.currentLine=31981574;
 //BA.debugLineNum = 31981574;BA.debugLine="If AllowMultiSelection Then";
...
RDebugUtils.currentLine=31981575;
 //BA.debugLineNum = 31981575;BA.debugLine="Sleep(20)";
...
RDebugUtils.currentLine=31981576;
 //BA.debugLineNum = 31981576;BA.debugLine="For i = 0 To CustomListView1.Size - 1";
if (true) break;
...
RDebugUtils.currentLine=31981577;
 //BA.debugLineNum = 31981577;BA.debugLine="Dim item As CLVItem = CustomListView1.GetRawLis";
_item = __ref._customlistview1 /*b4j.example.customlistview*/ ._getrawlistitem(_i);
RDebugUtils.currentLine=31981578;
 //BA.debugLineNum = 31981578;BA.debugLine="SelectItem (item, False)";
...
RDebugUtils.currentLine=31981581;
 //BA.debugLineNum = 31981581;BA.debugLine="XUIViewsUtils.AddStubToCLVIfNeeded(CustomListView";
...
RDebugUtils.currentLine=31981582;
 //BA.debugLineNum = 31981582;BA.debugLine="SelectedItem = \"\"";
__ref._selecteditem /*String*/  = "";
RDebugUtils.currentLine=31981584;
 //BA.debugLineNum = 31981584;BA.debugLine="End Sub";
if (true) break;
...
RDebugUtils.currentLine=32178176;
 //BA.debugLineNum = 32178176;BA.debugLine="Private Sub DialogClosed(Result As Int) 'ignore";
...
RDebugUtils.currentLine=31719428;
 //BA.debugLineNum = 31719428;BA.debugLine="Public Options As List";
_options = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=31719429;
 //BA.debugLineNum = 31719429;BA.debugLine="Public SelectedItem As String";
_selecteditem = "";
RDebugUtils.currentLine=31719430;
 //BA.debugLineNum = 31719430;BA.debugLine="Private xDialog As B4XDialog";
_xdialog = new b4j.example.b4xdialog();
RDebugUtils.currentLine=31719431;
 //BA.debugLineNum = 31719431;BA.debugLine="Public AllowMultiSelection As Boolean";
_allowmultiselection = false;
RDebugUtils.currentLine=31719432;
 //BA.debugLineNum = 31719432;BA.debugLine="Public SelectionColor As Int = 0xAA0086FF";
_selectioncolor = ((int)0xaa0086ff);
RDebugUtils.currentLine=31719433;
 //BA.debugLineNum = 31719433;BA.debugLine="Public SelectedItems As List";
_selecteditems = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=31719434;
 //BA.debugLineNum = 31719434;BA.debugLine="Public MultiSelectionMinimum As Int = 0";
...
RDebugUtils.currentLine=32112640;
 //BA.debugLineNum = 32112640;BA.debugLine="Private Sub CustomListView1_ItemClick (Index As In";
RDebugUtils.currentLine=32112641;
 //BA.debugLineNum = 32112641;BA.debugLine="If Value = \"\" Then Return";
if ((_value).equals((Object)(""))) { 
if (true) return "";};
RDebugUtils.currentLine=32112642;
 //BA.debugLineNum = 32112642;BA.debugLine="If AllowMultiSelection Then";
if (__ref._allowmultiselection /*boolean*/ ) { 
RDebugUtils.currentLine=32112643;
 //BA.debugLineNum = 32112643;BA.debugLine="Dim Item As CLVItem = CustomListView1.GetRawList";
_item = __ref._customlistview1 /*b4j.example.customlistview*/ ._getrawlistitem(_index);
RDebugUtils.currentLine=32112644;
 //BA.debugLineNum = 32112644;BA.debugLine="SelectItem (Item, True)";
__ref._selectitem /*String*/ (null,_item,__c.True);
 }else {
RDebugUtils.currentLine=32112646;
 //BA.debugLineNum = 32112646;BA.debugLine="SelectedItem = Value";
__ref._selecteditem /*String*/  = BA.ObjectToString(_value);
RDebugUtils.currentLine=32112647;
 //BA.debugLineNum = 32112647;BA.debugLine="SelectedItems.Clear";
__ref._selecteditems /*anywheresoftware.b4a.objects.collections.List*/ .Clear();
RDebugUtils.currentLine=32112648;
 //BA.debugLineNum = 32112648;BA.debugLine="SelectedItems.Add(Value)";
__ref._selecteditems /*anywheresoftware.b4a.objects.collections.List*/ .Add(_value);
RDebugUtils.currentLine=32112649;
 //BA.debugLineNum = 32112649;BA.debugLine="xDialog.Close(xui.DialogResponse_Positive)";
...
RDebugUtils.currentLine=32047104;
 //BA.debugLineNum = 32047104;BA.debugLine="Private Sub SelectItem (Item As CLVItem, Toggle As";
RDebugUtils.currentLine=32047105;
 //BA.debugLineNum = 32047105;BA.debugLine="Dim index As Int = SelectedItems.IndexOf(Item.Val";
...
RDebugUtils.currentLine=32047106;
 //BA.debugLineNum = 32047106;BA.debugLine="Dim Selected As Boolean = index > -1";
_selected = _index>-1;
RDebugUtils.currentLine=32047107;
 //BA.debugLineNum = 32047107;BA.debugLine="If Toggle Then Selected = Not(Selected)";
if (_toggle) { 
_selected = __c.Not(_selected);};
RDebugUtils.currentLine=32047108;
 //BA.debugLineNum = 32047108;BA.debugLine="If Selected Then";
if (_selected) { 
RDebugUtils.currentLine=32047109;
 //BA.debugLineNum = 32047109;BA.debugLine="If Not(Toggle) Then Item.Panel.Color = Selection";
if (__c.Not(_toggle)) { 
_item.Panel.setColor(__ref._selectioncolor /*int*/ );};
RDebugUtils.currentLine=32047110;
 //BA.debugLineNum = 32047110;BA.debugLine="Item.Color = CustomListView1.DefaultTextBackgrou";
...
RDebugUtils.currentLine=32047111;
 //BA.debugLineNum = 32047111;BA.debugLine="If index = -1 Then SelectedItems.Add(Item.Value)";
if (_index==-1) { 
__ref._selecteditems /*anywheresoftware.b4a.objects.collections.List*/ .Add(_item.Value);};
 }else {
RDebugUtils.currentLine=32047113;
 //BA.debugLineNum = 32047113;BA.debugLine="Item.Color = SelectionColor";
_item.Color = __ref._selectioncolor /*int*/ ;
RDebugUtils.currentLine=32047114;
 //BA.debugLineNum = 32047114;BA.debugLine="If Not(Toggle) Then Item.Panel.Color = CustomLis";
if (__c.Not(_toggle)) { 
...
RDebugUtils.currentLine=32047115;
 //BA.debugLineNum = 32047115;BA.debugLine="If index > -1 Then SelectedItems.RemoveAt(index)";
if (_index>-1) { 
__ref._selecteditems /*anywheresoftware.b4a.objects.collections.List*/ .RemoveAt(_index);};
 };
RDebugUtils.currentLine=32047117;
 //BA.debugLineNum = 32047117;BA.debugLine="xDialog.SetButtonState(xui.DialogResponse_Positiv";
...
RDebugUtils.currentLine=32047118;
 //BA.debugLineNum = 32047118;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=31784963;
 //BA.debugLineNum = 31784963;BA.debugLine="mBase.LoadLayout(\"ListTemplate\")";
...
RDebugUtils.currentLine=31784969;
 //BA.debugLineNum = 31784969;BA.debugLine="Dim sv As Node = CustomListView1.sv";
...
RDebugUtils.currentLine=31784970;
 //BA.debugLineNum = 31784970;BA.debugLine="sv.StyleClasses.Add(\"b4xdialog\")";
_sv.getStyleClasses().Add((Object)("b4xdialog"));
RDebugUtils.currentLine=31784972;
 //BA.debugLineNum = 31784972;BA.debugLine="Options.Initialize";
__ref._options /*anywheresoftware.b4a.objects.collections.List*/ .Initialize();
RDebugUtils.currentLine=31784973;
 //BA.debugLineNum = 31784973;BA.debugLine="SelectedItems.Initialize";
...
RDebugUtils.currentLine=31850498;
 //BA.debugLineNum = 31850498;BA.debugLine="CustomListView1.Base_Resize(Width, Height)";
